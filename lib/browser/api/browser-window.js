...
BrowserWindow.prototype._init = function () {
  ...
  // Exit HTML fullscreen when window leaves fullscreen
  this.on('leave-full-screen', (event) => {
    for (const webContents of getAllWebContents()) {
      if (webContents.getOwnerBrowserWindow() === this) {
        webContents.executeJavaScript('document.webkitExitFullscreen()')
      }
    }
  })
